...
async function S(t, a = P()) {
  const { path: s, matched: e } = a.resolve(t);
  if (
    !e.length ||
    (a._routePreloaded || (a._routePreloaded = new Set()),
    a._routePreloaded.has(s))
  )
    return;
  const r = (a._preloadPromises = a._preloadPromises || []);
  if (r.length > 4) return Promise.all(r).then(() => S(t, a));
  a._routePreloaded.add(s);
  const i = e
    .map((n) => {
      var o;
      return (o = n.components) == null ? void 0 : o.default;
    })
  ...
  const a = t.componentName || "NuxtLink",
    s = (e, r) => {
      if (!e || (t.trailingSlash !== "append" && t.trailingSlash !== "remove"))
        return e;
      const i = t.trailingSlash === "append" ? L : B;
        ...
        if (!o.value) {
          ...
          return (
            e.custom ||
              ...
              (c.rel = e.rel)),
            _(A("RouterLink"), c, r.default)
          );
        }
        const l =
            typeof n.value == "object"
              ? (((g = i.resolve(n.value)) == null ? void 0 : g.href) ?? null)
              : n.value || null,
          d = e.target || null,
          h = e.noRel
            ? null
            : D(e.rel, t.externalRelAttribute, l ? U : "") || null,
          u = () => E(l, { replace: e.replace });
        return e.custom
          ? r.default
            ? r.default({
                href: l,
...
const F = V({ componentName: "NuxtLink" });
function j() {
  const t = y();
