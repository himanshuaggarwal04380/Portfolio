...
var m = (r, t, e) =>
  t in r
    ? h(r, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
    : (r[t] = e);
...
class c {
  ...
  set(t, e, a = { days: 30 }) {
    ...
    this.storage.setItem(t, JSON.stringify({ timestamp: s, value: e }));
  }
  has(t) {
  ...
  getTimestamp(t) {
    let e = new Date();
    return (
      t.seconds && e.setSeconds(e.getSeconds() + t.seconds),
      t.minutes && e.setMinutes(e.getMinutes() + t.minutes),
      t.hours && e.setHours(e.getHours() + t.hours),
      t.days && e.setDate(e.getDate() + t.days),
      t.months && e.setMonth(e.getMonth() + t.months),
      t.years && e.setFullYear(e.getFullYear() + t.years),
      e.getTime()
    );
  }
  checkTimestamp(t) {
...
const n = class n {
  constructor() {
    ...
    ((o = document),
      o.querySelectorAll("[data-string-storage]").forEach((t) => {
        const e = (s) => {
        ...
        (t.querySelectorAll("input").forEach(e),
          t.querySelectorAll("textarea").forEach(e),
        ...
        t.addEventListener("submit", (s) => {
          (t.querySelectorAll("input").forEach(a),
            t.querySelectorAll("textarea").forEach(a),
            t.querySelectorAll("select").forEach(a));
        });
      }));
  }
  get local() {
